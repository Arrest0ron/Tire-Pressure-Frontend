...
export default defineConfig(({ mode }) => {
  ...
  const pwaName = "Tire Pressure Calculator";
  ...
  return {
    ...
    plugins: [
      react(),
      // ✅ Раскомментировано: mkcert для авто-генерации сертификатов (если нет ручных)
    ...
    server: {
      // ✅ Раскомментировано: HTTPS с ручными сертификатами (если есть cert.crt/key)
      ...(useManualHttpsCerts
        ? {
            https: {
